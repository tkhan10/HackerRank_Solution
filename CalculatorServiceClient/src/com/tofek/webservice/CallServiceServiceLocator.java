...
public class CallServiceServiceLocator extends org.apache.axis.client.Service implements com.tofek.webservice.CallServiceService {
    ...
    private java.lang.String CallService_address = "http://localhost:9090/CalculatorService/services/CallService";
    ...
    public com.tofek.webservice.CallService getCallService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tofek.webservice.CallServiceSoapBindingStub _stub = new com.tofek.webservice.CallServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tofek.webservice.CallService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tofek.webservice.CallServiceSoapBindingStub _stub = new com.tofek.webservice.CallServiceSoapBindingStub(new java.net.URL(CallService_address), this);
                _stub.setPortName(getCallServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.tofek.com", "CallServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.tofek.com", "CallService"));
        }
